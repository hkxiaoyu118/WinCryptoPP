#include "AesCbcCtsHelper.h"


AesCbcCtsHelper::AesCbcCtsHelper(std::string key, std::string iv)
{
...
AesCbcCtsHelper::~AesCbcCtsHelper()
{

}


std::string AesCbcCtsHelper::EncryptData(std::string data, std::string& errorString)
{
...
std::string AesCbcCtsHelper::DecryptData(std::string cryptedData, std::string& errorString)
{
